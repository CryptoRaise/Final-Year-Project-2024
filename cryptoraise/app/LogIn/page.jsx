...
const LogIn = () => {
  return (
    ...
    <div className="container h-[50%] w-[35%] m-auto p-3 bg-white">
      <h1 className="font-bold text-3xl my-4 text-center text-slate-600">Login</h1>
      <div className="px-2">
        <div className="mb-4">
      ...
      <div className="px-2">
        ...
        <div className=' flex gap-3 justify-center m-5'>
            ...
            <Link href="/SignUp"><span className=' font-bold cursor-pointer text-cyan-500'>Sign Up</span></Link>
        </div>
      </div>
    </div>
    </div>
