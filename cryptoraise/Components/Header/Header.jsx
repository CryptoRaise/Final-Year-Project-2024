  ...
  return (
    <div>
      ...
      <ul className=" flex gap-10 justify-between items-baseline">
        ...
        <ul className=" flex gap-9 justify-evenly m-5 font-bold text-lg">
          <li>
            <div className="flex m-0 rounded-md p-2 border-x-2 border-y-2">
              <input type="text" placeholder="Search.." />
              <img
                className="h-9 w-8 px-2 py-3 font-bold text-lg"
          ...
          <li>
            <button className=" border-x-2 border-y-2 border-green-700 rounded-md px-3 py-2 text-green-400">
              Login
            </button>
          </li>
        </ul>
